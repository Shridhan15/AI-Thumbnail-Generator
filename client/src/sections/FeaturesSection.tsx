...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why user our generator?" text3="Create stunning thumbnails that get clicks, without the hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae asperiores enim quos voluptas possimus corporis, sequi repellat voluptates ratione vitae.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Use our service without a second thought.</p>
